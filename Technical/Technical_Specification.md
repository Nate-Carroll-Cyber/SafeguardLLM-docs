...
Safeguard LLM now treats prompt concealment itself as a hostile act in the governed path.
...
| `Chunk Embedding` | Best overlapping chunk pgvector cosine similarity meets the chunk-review threshold. | `> 0.72` |
