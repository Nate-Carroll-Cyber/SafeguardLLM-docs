...
*   **Thresholds:** Scores at or above the configured suspicious threshold (`65` by default) contribute to `Suspicious` classification; scores at or above `90` independently trigger `Adversarial` classification.
